...
insert into students values ('107','Gregory',3,'FIN',3.1,2.9,null);
insert into students values (108,'Eric', 4, 'IS','3.1','2.9',null);
insert into students values (109,'Bob', 4, 'IS','3.1','2.9',null);

insert into students values (109,'Bob', 4, 'IS','3.1','2.9');

insert into students values (110,'Bob', 4, 'IS','3.1','2.9');
...
-- DO NOT ADD VALUES INTO WAITINGLIST THE ADDME PROCEDURE SHOULD BE DOING ALL THE ADDING 
...
insert into WaitingList values (null, 10110, 102, null);
insert into WaitingList values (null, 10110, 103, null);
insert into WaitingList values (null, 10110, 104, null);
insert into WaitingList values (null, 10115, 106, null);
insert into WaitingList values (null, 10115, 101, null);
insert into WaitingList values (null, 10125, 105, null);
